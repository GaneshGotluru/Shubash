...
const Assign = () => {
    ...
    let handleRemove=(id,username)=>{
        ...
        setMovie(movie.filter((data)=> id!==data.id))
    ...
    return (
        <>
            <h1 className='text-center py-5'>All Movies</h1>

            <div style={{ display: 'grid', gridTemplateColumns: 'auto auto auto auto', rowGap: "20px" }}>
                {
                    movie.map((user, i) => {
...
export function GitCard(props) {
    ...
    let { Images, Title,Genre,Released,imdbRating,id,Year} = props.user
    ...
    return (
        <div className="card" style={{ width: "14rem" }}>
            ...
            <div className="card-body">
                ...
                {/* <button onClick={()=>handleYear(Year)}>After: 2012</button> */}
            </div>
